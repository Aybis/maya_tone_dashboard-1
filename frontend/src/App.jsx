      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-8">
        <div>
          ...
          <nav className="flex flex-col gap-1">
            ...
            <button
              ...
              className={`text-left px-3 py-2 rounded-md text-sm font-medium w-full ${location.pathname.startsWith('/canvas') ? 'bg-blue-500/20 text-blue-300' : 'text-slate-400 hover:text-blue-300 hover:bg-blue-500/10'}`}
            >Canvas</button>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <button onClick={async () => { const id = await createNewChat(); if (id) navigate(`/chat/${id}`); }} className="text-xs px-2 py-1 rounded bg-blue-600 text-white hover:bg-blue-500">+ New</button>
          </div>
